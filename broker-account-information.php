...
if(isset($_POST['submit'])){
  ...
  $sqlsubmit = "UPDATE Broker
                SET first_name ='$first_name', last_name ='$last_name', email = '$email', phone_number = '$phone_number', country ='$country', city ='$city', postcode='$postcode', brokage_name='$brokage_name', broker_license_number='$broker_license_number', company_name='$company_name', company_registration_number='$company_registration_number', company_country='$company_country'
                WHERE Broker_ID='$Broker_ID'";
  ...
  <div class="reg">
    ...
    <form action="broker-account-information.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="broker_license_number" name="broker_license_number" value="<?php echo $row['broker_license_number']; ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="company_license_number" name="company_license_number"value=" <?php echo $row['company_registration_number']; ?>" required>
        </div>
        <div class="form-group">
            <label for="company_country" class="form-label">Country:</label>
            <input type="text" class="form-control" id="company_country" name="company_country" value="<?php echo $row['company_country']; ?>" required>
        </div>
